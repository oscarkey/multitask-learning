...
def poly_lr_scheduler(optimizer, init_lr, _iter, lr_decay_iter=1,                                               
                            max_iter=50000, power=0.9):
    """Polynomial decay of learning rate
        :param init_lr is base learning rate
        :param _iter is a current iteration
    ...
    lr = init_lr*(1 - _iter/max_iter)**power
